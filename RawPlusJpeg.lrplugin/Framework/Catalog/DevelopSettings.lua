...
DevelopSettings.table = { -- static table with all info for all settings.
    ...
    {   groupName="Basic",
        members={
            ...
            { members = { -- anonymous sub-group
                { id='Temperature', friendly="Temperature (Raw)", dataType = 'number', baseAdj=50, constraints = { min=-10000, max=10000 }, prereq = { name='WhiteBalance', value='Custom' } }, -- ###1 @28/Sep/2013 9:33, these constraints seem wrong.
    ...
    {   groupName = "B&&W",
        members={
            ...
            { id='EnableGrayscaleMix', friendly="Enable Black && White", dataType = 'boolean' }, -- Note: this is the section enable/disable! ###1
            { members={
